    ...
    <div class="join_now_bannner">
      <div class="container sports_container">
        <div class="event_content">
          <!-- <h1 class="event_headng">The {{$event->name}} is coming soon</h1>
        ...
        <div class="test_join_box">
          ...
          <div id="event-details" style=" text-align: center; margin-top: 20px; font-size: 1.2em;">
            <p>
              ...
              <strong>{{ \Carbon\Carbon::parse($event->date)->format('F d, Y h:i A') }}</strong>
            </p>
            <p>
              Registration will end on:
              <strong>{{ \Carbon\Carbon::parse($event->enddate)->format('F d, Y h:i A') }}</strong>
            </p>
              ...
              <div class="container sports_container">
                <div class="login_box">
                  <ul class="join_now_list">
                    <input type="hidden" name="session_name" value="{{ $event->name }}">
                    <!-- First Name -->
                    @if(Auth::check())
                      ...
                      <div class="radio_box mb_30">
                        ...
                        <div class="form-check remember_check radio_check hidden">
                          ...
                          <label class="form-check-label text-white" for="radiocheck_single" style="color:black">
                            Singles - ${{ number_format($event->pricing, 2) }}
                          </label>
                        </div>
                        @elseif($event->selected_game == 'doubles')
                        <div class="form-check remember_check radio_check hidden">
                          <input class="form-check-input" checked type="radio" name="game_type" value="{{ $event->double_price }}" id="radiocheck_double" data-type="doubles">
                          <label class="form-check-label text-white" for="radiocheck_double" style="color:black">
                            Doubles - ${{ number_format($event->double_price, 2) }}
                          </label>
                        </div>
                        @endif

                        <input type="hidden" name="selected_game" id="selected_game" value="{{ $event->selected_game }}">
                    ...
                    <li>
                      <div class="radio_box mb_30">
                        ...
                        @if($event->skill_level == 'beginner')
                        <div class="form-check join_now_radio hidden">
                          <input class="form-check-input" checked type="radio" name="flexRadioDefault" value="beginner" id="radiocheck1">
                        ...
                        @elseif($event->skill_level == 'advanced')
                        <div class="form-check join_now_radio hidden">
                          <input class="form-check-input" checked type="radio" name="flexRadioDefault" value="advanced" id="radiocheck2">
